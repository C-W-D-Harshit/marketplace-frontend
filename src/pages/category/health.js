...
const Health = ({ Dproducts, Nproducts }) => {
  return (
    <div className="electronics">
      <div className="electronics_banner">
        <p>Grab Upto 50% Off On Selected Product</p>
...
export async function getServerSideProps() {
  ...
  let data1 = [];
  try {
    res = await fetch(`${baseUrl}/api/v1/products/dod?category=health`);
    data = await res.json();
    res1 = await fetch(`${baseUrl}/api/v1/products/nA?category=health`);

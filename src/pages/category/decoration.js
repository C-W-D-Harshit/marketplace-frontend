...
const Decoration = ({ Dproducts, Nproducts }) => {
  return (
    <div className="electronics">
      <div className="electronics_banner">
        <p>Grab Upto 50% Off On Selected Decor Products</p>
...
export async function getServerSideProps() {
  ...
  let data1 = [];
  try {
    res = await fetch(`${baseUrl}/api/v1/products/dod?category=decoration`);
    data = await res.json();
    res1 = await fetch(`${baseUrl}/api/v1/products/nA?category=decoration`);
